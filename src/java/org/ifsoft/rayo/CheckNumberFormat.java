...
public class CheckNumberFormat extends HttpServlet{
    ...
    @Override protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("        <meta name=\"pageID\" content=\"freeswitch-check-number\"/>");
        ...
        out.println("    </head>");
        out.println("    <body>");
        out.println("<form action=\"freeswitch-check-number-format\" method=\"get\">");
        ...
        String siePbxAccessDigits   = JiveGlobals.getProperty(RayoComponent.Properties.PBX_ACCESS_DIGITS    , "");
        String siteAreaCode         = JiveGlobals.getProperty(RayoComponent.Properties.AREA_CODE            , "");
        String sitePbxNumberLength  = JiveGlobals.getProperty(RayoComponent.Properties.PBX_NUMBER_LENGTH    , "");
        String sitePbxNumberPrefix  = JiveGlobals.getProperty(RayoComponent.Properties.PBX_NUMBER_PREFIX    , "");
        String sitePbxTrunkCode     = JiveGlobals.getProperty(RayoComponent.Properties.PBX_AREA_TRUNK_CODE  , "");
        String sitePhoneNumberLength = JiveGlobals.getProperty(RayoComponent.Properties.PBX_LOCAL_PHONE_NUMBERLENGTH, "");
        String siteUseIDDFormat     = JiveGlobals.getProperty(RayoComponent.Properties.PBX_USE_IDD       , "");
        ...
        out.println("<option selected value='" + scriptArgument + "'>Default</option>");
